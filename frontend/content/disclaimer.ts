export const disclaimerContent = {
  es: {
    ...
    warningAlert:
      "Esta herramienta no reemplaza la asesoría de un abogado de inmigración. / This tool does not replace advice from an immigration attorney.",
    checkLabel:
      "Entiendo y acepto estos términos. / I understand and agree to these terms.",
    cta: "Continuar",
  },
  en: {
    title: "Disclaimer",
    ...
    warningAlert:
      "This tool does not replace advice from an immigration attorney. / Esta herramienta no reemplaza la asesoría de un abogado de inmigración.",
    checkLabel:
      "I understand and agree to these terms. / Entiendo y acepto estos términos.",
    cta: "Continue",
  },
};
